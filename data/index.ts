export const navItems = [
  ...
  { name: "Companies", link: "#trusted-by" },
...
export const workExperience = [
  ...
  {
    id: 2,
    title: "Software Engineering Fellow & ScrumMaster",
  ...
  {
    id: 6,
    title: "Corporate Venture Capital & Business Analytics Externship",
  ...
  },
  {
    ...
    company: "Fifth Avenue Valets Ltd",
    desc: [
    ...
    date: "2021-08 - 2023-01",
    categories: ["customerservice"]
  },
  {
    id: 9,
    title: "Bellman",
    company: "Exchange Hotel Vancouver",
    desc: [
  ...
  {
    id: 10,
    title: "Youth Football Referee",
    company: "Lower Mainland Football Referee Association",
    desc: [
    ...
    className: "md:col-span-2",
    thumbnail: "/lmfra.png",
    date: "2019-08 - 2021-11",
    categories: ["sports"]
  },
  {
    id: 11,
    title: "Ice Hockey Timekeeper",
    company: "Canlan Sports",
    desc: [
  ...
  },
  {
    ...
    date: "2013-05 - 2015-06",
    categories: ["all"]
  },
  {
    id: 15,
    title: "Manager & Team Captain",
    company: "Ruthless Aggression Touch Football Team",
    desc: [
...
export const certificationsData = [
  ...
  {
    id: 2,
    title: "Accenture Technical Consulting Job Simulation",
